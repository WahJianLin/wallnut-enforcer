...
Discord for Typescript is a powerful [Node.js](https://nodejs.org) module that allows you to easily interact with the
...
Without voice support: `npm install discord-typescript`  
